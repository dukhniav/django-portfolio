...
urlpatterns = [
    ...
    path('login/', csrf_exempt(LoginView.as_view(template_name='todos/login.html')),
         name='todos_login'),
    path('logout/', LogoutView.as_view(template_name='todos/logout.html'),
         name='todos_logout'),
    path('settings/', SettingsView.as_view(template_name='todos/settings.html'),
         name='todos_settings'),
